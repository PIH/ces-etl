...
EXEC sp_rename 'dbo.fecha.DayOfMonth', 'día', 'COLUMN';
EXEC sp_rename 'dbo.fecha.Month', 'mes', 'COLUMN';
EXEC sp_rename 'dbo.fecha.Year', 'Año', 'COLUMN';
...
EXEC sp_rename 'dbo.fecha.FirstDayOfMonth', 'primer_día_del_mes', 'COLUMN';

EXEC sp_rename 'dbo.fecha.FullDateUK', 'FechaCompletaUK', 'COLUMN';
EXEC sp_rename 'dbo.fecha.FullDateUSA', 'FechaCompletaUSA', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DaySuffix', 'DíaSufijo', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DayName', 'DíaNombre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DayOfWeekUSA', 'DíadelaSemanaUSA', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DayOfWeekUK', 'DíadelaSemanaUK', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DayOfWeekInMonth', 'DíadelasemanaenMes', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DayOfWeekInYear', 'DíadelasemanaenAño', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DayOfQuarter', 'DíadelTrimestre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.DayOfYear', 'DíadelAño', 'COLUMN';
EXEC sp_rename 'dbo.fecha.WeekOfMonth', 'SemanadelMes', 'COLUMN';
EXEC sp_rename 'dbo.fecha.WeekOfQuarter', 'SemanadelTrimestre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.WeekOfYear', 'SemanadelAño', 'COLUMN';
EXEC sp_rename 'dbo.fecha.MonthName', 'MesNombre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.MonthOfQuarter', 'MesdelTrimestre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.QuarterName', 'TrimestreNombre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.YearName', 'AñoNombre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.MonthYear', 'MesAño', 'COLUMN';
EXEC sp_rename 'dbo.fecha.LastDayOfMonth', 'último_día_del_mes', 'COLUMN';
EXEC sp_rename 'dbo.fecha.FirstDayOfQuarter', 'primer_día_del_trimestre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.LastDayOfQuarter', 'último_día_del_trimestre', 'COLUMN';
EXEC sp_rename 'dbo.fecha.FirstDayOfYear', 'primer_día_del_año', 'COLUMN';
EXEC sp_rename 'dbo.fecha.LastDayOfYear', 'último_día_del_año', 'COLUMN';
EXEC sp_rename 'dbo.fecha.IsHolidayUSA', 'EsDíaFeriadoUSA', 'COLUMN';
EXEC sp_rename 'dbo.fecha.IsWeekday', 'EsDíaLaborable', 'COLUMN';
EXEC sp_rename 'dbo.fecha.HolidayUSA', 'DíaFeriadoUSA', 'COLUMN';
EXEC sp_rename 'dbo.fecha.IsHolidayUK', 'EsDíaFeriadoUK', 'COLUMN';
EXEC sp_rename 'dbo.fecha.HolidayUK', 'DíaFeriadoUK', 'COLUMN';